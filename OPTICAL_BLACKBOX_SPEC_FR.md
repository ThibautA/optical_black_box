...
**Simplified principle**: Encrypt raw file bytes → Decrypt → Restore exact original file
...
│  • Read raw file (bytes)                │  →   │  • Decryption                   │
│  • Encryption ECDH + AES-256-GCM        │ .obb │  • Original file restoration    │
│  • Minimal metadata                     │      │  • Use for raytracing           │
